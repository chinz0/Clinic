										...
										<form class="form" role="form" method="POST" accept-charset="UTF-8">
											<div class="panel panel-default">
												...
												<div class="panel-body">
													...
													Account Number: <?php echo $userRow['icPatient'] ?><br>
											...
											<div class="form-group">
												<br><label for="recipient-name" class="control-label">Case Description:</label></br>
												<input type="radio" id="ultrasound" name="fav_language" value="ULTRASOUND">
											 <label for="ultrasound">Ultrasound</label><br>
											 <input type="radio" id="transvaginal" name="fav_language" value="TRANSVAGINAL">
											 <label for="transvaginal">Transvaginal</label><br>
											 <input type="radio" id="transabdominal" name="fav_language" value="TRANSABDOMINAL">
											 <label for="transabdominal">Transabdominal Care</label><br>
											 <input type="radio" id="transrectal" name="fav_language" value="TRANSRECTAL">
											 <label for="transrectal">Transrectal</label><br>

                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="FirstName" disabled><r/th>
                            ...
                            while ($appointment=mysqli_fetch_array($res)) {
                                ...
                                echo "<tr class='$status'>";
                                    ...
                                    echo "<td class='text-center'><a href='#' id='".$appointment['appId']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'>
                                    </span></a>

...
(123456789, '123', 123, 'Reynold', 'Edillon', 'Summerlight Brgy. Magsaysay South Cotabato', '0909*******', 'Clinic@gmail.com', '1990-04-10');
...
(01, '2021-12-13', 'Monday', '08:00:00', '08:30:00', 'notavail'),
(02, '2021-12-13', 'Monday', '08:30:00', '09:00:00', 'available'),
(03, '2021-12-13', 'Monday', '09:00:00', '09:30:00', 'available'),
(04, '2021-12-13', 'Monday', '09:30:00', '10:00:00', 'available'),
(05, '2021-12-13', 'Monday', '10:00:00', '10:30:00', 'available');
...
(920517105553, '123', 'Mich', 'Lim', 'single', '1998-05-17', 'male', 'BARANAGY MAGSAYSAY,SOUTH COTABATO', '09099200002', 'mich@gmail.com');
...
--
ALTER TABLE `doctorschedule`
  MODIFY `scheduleId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=06;

						...
						echo "<div class='row'>";
							echo "<div class='col-lg-12'>";
								echo "<div class='alert alert-danger alert-dismissable'>";
									...
									echo " <i class='fa fa-info-circle'></i>  <strong>Please fill in the required field.</strong>" ;
								echo "  </div>";
							echo "</div>";
							// <!-- notification end -->
							...
							?>
							<!-- notification end -->
							<h2>GoodDay! <?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?>. Set an Appointment!</h2>

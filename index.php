...
//INSERT
$query = " INSERT INTO patient (  icPatient, password, patientFirstName, patientLastName,  patientDOB, patientEmail )
VALUES ( '$icPatient', '$password', '$patientFirstName', '$patientLastName', '$patientDOB', '$patientEmail' ) ";
...
<html lang="en">
    ...
    <body>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="icPatient" placeholder="Account Number" required>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" name="login" id="login" class="btn btn-info btn-block">Sign in</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <input type="text" name="patientEmail" value="" class="form-control input-lg" placeholder="Email Address"  required/>
                                        <input type="number" name="icPatient" value="" class="form-control input-lg" placeholder="Account Number"  required/>
                                        ...
                                        <br />
                                        <span class="help-block">I accept the Terms of Use & Privacy Policy</span>
                                        
                                        <button class="btn btn-info btn-primary btn-block signup-btn" type="submit" name="signup" id="signup">Create Account</button>
                                    </form>
        ...
        <!-- 1st section start -->
       <section id="promo-4" class="content-block promo-4 min-height-600px bg-offwhite"> 
            <div class="container">
                <div class="row">  
                    <div class="col-md-12">
                     <h2 style="text-align:center;">Set Your Appointment Now</h2>
                      <center>  <p>Please <span class="label label-primary">login</span> to Set an appointment. </p> </center>
        ...
        <!-- forth section end -->
        <!-- footer start -->
        <div class=" bg-moonlight-hover-hover">
            <div class="container">
